...
public class CustomListForViewReserve extends BaseAdapter{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       // holder.btnUnlockConnector = (Button) rowView.findViewById(R.id.btnUnlockConnector);
        ...
        /*
        holder.btnUnlockConnector.setOnClickListener(new View.OnClickListener() {
            @Override
